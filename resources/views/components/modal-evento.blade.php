...
x-data = "{
    ...
    openModal(event){
        ...
        this.myModal = new bootstrap.Modal('#modal-evento-uptade');
        this.myModal.show();
    },
    async send(){
...
@open-evento-modal.window="openModal"
>
    <div class="modal fade" tabindex="-1" id='modal-evento-uptade' aria-labelledby="modal-eventoLabel" aria-hidden="true">
